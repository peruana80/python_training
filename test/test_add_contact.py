...
def test_add_new_contact(app):
    ...
    app.contact.fill_new(Contact(first_name="imie", middle_name="drugie imie", last_name="nazwisko", nickname="ksywa", title="tytul",
...
def test_add_new_empty_contact(app):
    app.session.login(username="admin", password="secret")
    app.contact.fill_new(Contact(first_name="", middle_name="", last_name="", nickname="",
